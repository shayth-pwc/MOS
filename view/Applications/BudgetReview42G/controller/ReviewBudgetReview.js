sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.BudgetReview42G.controller.ReviewBudgetReview", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "pwc.portal.eval.ClubEvaluations.view.Applications.BudgetReview42G.view.ReviewBudgetReview", this);
			this._bInit = false;
		},
