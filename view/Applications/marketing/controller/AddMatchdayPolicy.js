sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.marketing.controller.AddMatchdayPolicy", {
		club_dms_id: '',
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(),
				"pwc.portal.eval.ClubEvaluations.view.Applications.marketing.view.AddMatchdayPolicy", this);
			this._bInit = false;
		},
		...
		onInit: function () {
			...
			this.oModel = this.getOwnerComponent().getModel("ProcedureGuides");
		...
		handleUploadPress: function (oEvent) {
			...
			var oModel = this._oControl.getModel("ProcedureGuides");

			var file = oEvent.getParameter("files")[0];
			var sBindingPath = oEvent.getSource().getBindingContext("ProcedureGuides").getPath(); // oEvent.get
		...
		openlink: function (oEvent) {
			var sLink = '';
			var filename = this.getView().byId('myFileUploadmatchdaypolicy').getBindingContext("ProcedureGuides").getProperty('proof_cmis_id');
