sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.MatchdayPolicy.controller.CopyOfAddMatchdayPolicy", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "pwc.portal.eval.ClubEvaluations.view.Applications.MatchdayPolicy.view.CopyOfAddMatchdayPolicy", this);
			this._bInit = false;
		},
		...
		_onButtonPress1: function(oEvent) {
			...
			if (oModel.hasPendingChanges()) {
				MessageBox.confirm(oResourceBundle.getText('ConfirmCancel'), {
					onClose: function (oAction) {
						if (oAction === sap.m.MessageBox.Action.OK) {
							that.getView().getModel("MatchdayPolicy").resetChanges();
							that.getView().getModel("MatchdayPolicy").refresh();
				...
				this.getView().getModel("MatchdayPolicy").resetChanges();
		...
		onInit: function() {
			...
			this.oModel = this.getOwnerComponent().getModel("MatchdayPolicy");
		...
		onExit: function() {
			...
			var oModel = this._oControl.getModel("MatchdayPolicy");

			var file = oEvent.getParameter("files")[0];
			var sBindingPath = oEvent.getSource().getBindingContext("MatchdayPolicy").getPath(); // oEvent.get
