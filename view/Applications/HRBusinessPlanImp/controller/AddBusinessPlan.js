sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.HRBusinessPlanImp.controller.AddBusinessPlan", {
		club_dms_id:'',

		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "pwc.portal.eval.ClubEvaluations.view.Applications.HRBusinessPlanImp.view.AddBusinessPlan", this);
			this._bInit = false;
		},
		...
		var oResourceBundle = this.getView().getModel("i18n").getResourceBundle();
			...
			if (oModel.hasPendingChanges()) {
				MessageBox.confirm(oResourceBundle.getText('ConfirmCancel'), {
					onClose: function (oAction) {
						if (oAction === sap.m.MessageBox.Action.OK) {
							that.getView().getModel("HRBusinessPlanImp").resetChanges();
							that.getView().getModel("HRBusinessPlanImp").refresh();
				...
				this.getView().getModel("HRBusinessPlanImp").resetChanges();
...
var that=this;
			...
			this.oModel = this.getOwnerComponent().getModel("HRBusinessPlanImp");
	...
	handleUploadPress: function (oEvent) {
			...
			var oModel = this._oControl.getModel("HRBusinessPlanImp");

			var file = oEvent.getParameter("files")[0];
			var sBindingPath = oEvent.getSource().getBindingContext("HRBusinessPlanImp").getPath(); // oEvent.get
		...
		handleCreateChange: function (oEvent) {
			var oDateTimePickerStart = this.getView().byId("plan_start_date"),
				oDateTimePickerEnd = this.getView().byId("plan_end_date");
