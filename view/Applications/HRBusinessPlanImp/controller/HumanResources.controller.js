sap.ui.define([
		...
		"use strict";
		return BaseController.extend("pwc.portal.eval.ClubEvaluations.view.Applications.HRBusinessPlanImp.controller.HumanResources", {
	...
	var oContext = this.getView().getModel("HRBusinessPlanImp").createEntry("/HRBIZPLANEVIDENCE", {
				properties: {
					id: '-1',
					...
					plan_start_date:this.getView().byId("plan_start_date").mProperties.value,
					plan_end_date: this.getView().byId("plan_end_date").mProperties.value,
			...
			oDialog._oControl.setBindingContext(oContext,"HRBusinessPlanImp");
			oDialog.open();
			...
			editbusinessplan: function (e) {
				...
				var o = e.getSource().getBindingContext("HRBusinessPlanImp");
				i._oControl.setBindingContext(o, "HRBusinessPlanImp");
				i.open();
			},
			deletebusinessplan: function (oEvent) {
				var oResourceBundle = this.getView().getModel("i18n").getResourceBundle();
				var that = this,
					sPath = oEvent.getSource().getParent().getBindingContext("HRBusinessPlanImp").getPath(),
					oModel = that.getView().getModel("HRBusinessPlanImp");
			...
			_onOverflowToolbarButtonPress3: function (oEvent) {
				...
				var context = oEvent.getSource().getBindingContext("HRBusinessPlanImp");
				oDialog._oControl.setBindingContext(context, "HRBusinessPlanImp");
				oDialog.open();
			},
			...
			_onRowPress: function (oEvent) {
				var oBindingContext = oEvent.getSource().getBindingContext("HRBusinessPlanImp");
			...
			doNavigate: function (sRouteName, oBindingContext, fnPromiseResolve, sViaRelation) {
				...
				var oModel = oBindingContext ? oBindingContext.getModel("HRBusinessPlanImp") : null;
				var sEntityNameSet;
				if (sPath !== null && sPath !== "") {
			...
			/**
			 *@memberOf pwc.portal.eval.ClubEvaluations.view.Applications.HRBusinessPlanImp.controller.HumanResources
			 */
