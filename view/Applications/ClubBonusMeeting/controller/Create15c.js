sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.ClubBonusMeeting.controller.Create15c", {
		club_dms_id:'',
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "pwc.portal.eval.ClubEvaluations.view.Applications.ClubBonusMeeting.view.Create15c", this);
			this._bInit = false;
		},
...
/*
		_onCancel15c: function () {
		console.log(this._oControl);
			var self = this;
			var sPath;
			sPath = this._oControl.getBindingContext("ClubBonusmeeting").getPath();
			sPath = sPath.replace('/', '');
			if (this._oControl.getModel("ClubBonusmeeting").getPendingChanges()[sPath]) {
				this._oControl.getModel("ClubBonusmeeting").resetChanges([this._oControl.getBindingContext("ClubBonusmeeting").getPath()], undefined,
					true);
			}
