sap.ui.define([
	...
	"pwc/portal/eval/ClubEvaluations/service/RepoService", "sap/ui/model/json/JSONModel"
], function (ManagedObject, MessageBox, History, RepoService, JSONModel) {

	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.OfficialClubStrategy.controller.NewCompetitionAnalysis", {

		club_dms_id: '',
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(),
				"pwc.portal.eval.ClubEvaluations.view.Applications.OfficialClubStrategy.view.NewCompetitionAnalysis", this);
			this._bInit = false;
		},
		...
		_getRequiredFields: function () {
			...
			return [{
				...
				"id": "ReasonCompetitorSelectiontext"
			}, {
				"id": "CompetitionComparisonText"
			}];
		},
