sap.ui.define([
	...
	"../model/formatter"
], function (ManagedObject, MessageBox, History, RepoService, formatter) {

	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.OfficialClubStrategy.controller.ReviewNewGoal", {
		formatter: formatter,

		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(),
				"pwc.portal.eval.ClubEvaluations.view.Applications.OfficialClubStrategy.view.ReviewNewGoal", this);
			this._bInit = false;
		},
