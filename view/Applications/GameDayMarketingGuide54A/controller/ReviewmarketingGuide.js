sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.GameDayMarketingGuide54A.controller.ReviewmarketingGuide", {
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(),
				"pwc.portal.eval.ClubEvaluations.view.Applications.GameDayMarketingGuide54A.view.ReviewmarketingGuide", this);
			this._bInit = false;
		},
		...
		renderPDF: function (oEvent) {
			//Generate the token
			var modeldata = this.getView().byId("plans").oParent.mObjectBindingInfos.marketingGuide.path;

			var data = this.getOwnerComponent().getModel("marketingGuide").getProperty(modeldata);
			console.log(data);
