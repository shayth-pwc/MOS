sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.StakeholderGathering34G.controller.ReviewStakeholderGathering", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "pwc.portal.eval.ClubEvaluations.view.Applications.StakeholderGathering34G.view.ReviewStakeholderGathering", this);
			this._bInit = false;
		},
