	...
	return BaseController.extend("pwc.portal.eval.ClubEvaluations.view.Applications.PowerScales.controller.Main", {
		...
		onInit: function () {
			...
			var oProcTemplate = new sap.ui.core.Item({
				key: "{RacyMatrix>procedure_name}",
				text: "{RacyMatrix>procedure_description}"
			});
			...
			var oDepartmentTemplate = new sap.ui.core.Item({
				key: "{RacyMatrix>club_com_name}",
				text: "{RacyMatrix>club_com_name}"
			});
			...
			oResponsiblePerson.bindItems({
				path: "RacyMatrix>/CLUB_ORG_STRUC_EMP",
			...
			this.oEditableTempRacyMatrix = new sap.m.ColumnListItem({
				cells: [
					...
					// new sap.m.ComboBox({
					// 	items: {
					// 		path: "{RacyMatrix>/Optional_Policies}",
					// 			templateShareable:true,							
					// 		template: new sap.ui.core.Item({
					// 			key: "{RacyMatrix>policy_name}",
					// 			text: "{RacyMatrix>policy_description}"
					// 		})
					// 	}
					// }),
					// new sap.m.Input({
					...
					// 	dateValue: "{RacyMatrix>start_date_time}"
					// }),
					// new sap.m.DatePicker({
					// 	dateValue: "{RacyMatrix>end_date_time}"
					// }),
					new sap.m.Button({
