sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.ReportingStrategy.controller.CopyOfDialog2", {
		club_dms_id:'',
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "pwc.portal.eval.ClubEvaluations.view.Applications.ReportingStrategy.view.CopyOfDialog2", this);
			this._bInit = false;
		},
