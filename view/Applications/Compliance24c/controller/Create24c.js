sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.Compliance24c.controller.Create24c", {
		club_dms_id: '',

		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "pwc.portal.eval.ClubEvaluations.view.Applications.Compliance24c.view.Create24c",
				this);
			this._bInit = false;
		},
		...
		_onCancel: function () {
			var self = this;
			var sPath;
			sPath = this._oControl.getBindingContext("complianceProc").getPath();
			sPath = sPath.replace('/', '');
			if (this._oControl.getModel("complianceProc").getPendingChanges()[sPath]) {
				this._oControl.getModel("complianceProc").resetChanges([this._oControl.getBindingContext("complianceProc").getPath()], undefined, /*bDeleteCreatedEntities*/
					true);
			}
		...
		handleUploadPress: function (oEvent) {
			...
			var oModel = this._oControl.getModel("complianceProc");

			var file = oEvent.getParameter("files")[0];
			var sBindingPath = oEvent.getSource().getBindingContext("complianceProc").getPath(); // oEvent.get
		...
		onInit: function () {
			...
			this.oModel = this.getOwnerComponent().getModel("complianceProc");
			var that = this
