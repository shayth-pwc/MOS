sap.ui.define([
	...
	return ManagedObject.extend(
		"pwc.portal.eval.ClubEvaluations.view.Applications.MarketingMatchStrategy54G.controller.ReviewMarketingStrategy", {
			constructor: function (oView) {
				this._oView = oView;
				this._oControl = sap.ui.xmlfragment(oView.getId(),
					"pwc.portal.eval.ClubEvaluations.view.Applications.MarketingMatchStrategy54G.view.ReviewMarketingStrategy", this);
				this._bInit = false;
			},
