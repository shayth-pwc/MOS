sap.ui.define([
	...
	return ManagedObject.extend(
		"pwc.portal.eval.ClubEvaluations.view.Applications.MarketingMatchStrategy54G.controller.CreateNewMarketingStrategy", {
			club_dms_id: '',

			constructor: function (oView) {
				this._oView = oView;
				this._oControl = sap.ui.xmlfragment(oView.getId(),
					"pwc.portal.eval.ClubEvaluations.view.Applications.MarketingMatchStrategy54G.view.CreateNewMarketingStrategy", this);
				this._bInit = false;
			},
			...
			_onSubmit: function (oEvent) {
				...
				if (status) {
					...
					var oModel = oView.getModel("MarketingMatchStrategy");

					var sBindingPath = oEvent.getSource().getBindingContext("MarketingMatchStrategy").sPath;
			...
			_onCancel: function () {
				var self = this;
				var sPath;
				sPath = this._oControl.getBindingContext("MarketingMatchStrategy").getPath();
				sPath = sPath.replace('/', '');
				if (self.oModel.getPendingChanges()[sPath]) {
					self.oModel.resetChanges([this._oControl.getBindingContext("MarketingMatchStrategy").getPath()], undefined, /*bDeleteCreatedEntities*/
						true);
				}
			...
			onInit: function () {
				...
				this.oModel = this.getOwnerComponent().getModel("MarketingMatchStrategy");
			...
			handleUploadPress: function (oEvent) {
				...
				var oModel = this._oControl.getModel("MarketingMatchStrategy");

				var file = oEvent.getParameter("files")[0];
				var sBindingPath = oEvent.getSource().getBindingContext("MarketingMatchStrategy").getPath(); // oEvent.get
