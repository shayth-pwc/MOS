sap.ui.define([
	...
	return ManagedObject.extend(
		"pwc.portal.eval.ClubEvaluations.view.Applications.PerformanceIndicatores13G.controller.ReviewPerformanceIndicator", {
			constructor: function (oView) {
				this._oView = oView;
				this._oControl = sap.ui.xmlfragment(oView.getId(),
					"pwc.portal.eval.ClubEvaluations.view.Applications.PerformanceIndicatores13G.view.ReviewPerformanceIndicator", this);
				this._bInit = false;
			},
