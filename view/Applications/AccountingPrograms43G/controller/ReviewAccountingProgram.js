sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.AccountingPrograms43G.controller.ReviewAccountingProgram", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "pwc.portal.eval.ClubEvaluations.view.Applications.AccountingPrograms43G.view.ReviewAccountingProgram", this);
			this._bInit = false;
		},
