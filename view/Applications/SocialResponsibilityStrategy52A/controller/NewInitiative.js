...
], function (ManagedObject, MessageBox, Utilities, History, JSONModel, Fragment, Filter, FilterOperator, RepoService) {

	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.SocialResponsibilityStrategy52A.controller.NewInitiative", {
		club_dms_id: '',

		constructor: function (oView, sEvent) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(),
				"pwc.portal.eval.ClubEvaluations.view.Applications.SocialResponsibilityStrategy52A.view.NewInitiative", this);
			this._bInit = false;
			this._Event = sEvent;
		},
		...
		onValueHelpRequest: function (oEvent) {
			...
			if (!this._pValueHelpDialog) {
				this._pValueHelpDialog = Fragment.load({
					id: oView.getId(),
					name: "pwc.portal.eval.ClubEvaluations.view.Applications.SocialResponsibilityStrategy52A.view.ValueHelpDialog",
					controller: this
			...
			this._pValueHelpDialog.then(function (oDialog) {
				...
				oView.byId("selectDialog").bindAggregation("items", "socialresponsibility>/CLUB_ORG_STRUC_EMP", new sap.m.StandardListItem({
					description: "{socialresponsibility>id}",
					title: "{socialresponsibility>emp_name}",
					info: "{socialresponsibility>club_dept_name}"
				}));
