sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.SocialResponsibilityStrategy52A.controller.ReviewNewCard", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "pwc.portal.eval.ClubEvaluations.view.Applications.SocialResponsibilityStrategy52A.view.ReviewNewCard", this);
			this._bInit = false;
		},
		...
		renderPDF: function (oEvent) {
			//Generate the token
			var modeldata = this.getView().byId("activities").oParent.oBindingContexts.socialresponsibility.sPath;
