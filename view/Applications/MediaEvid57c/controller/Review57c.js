sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.MediaEvid57c.controller.Review57c", {
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "pwc.portal.eval.ClubEvaluations.view.Applications.MediaEvid57c.view.Review57c",
				this);
			this._bInit = false;
		},
		...
		onInit: function () {
			...
			this.oModel = this.getOwnerComponent().getModel("MediaEvid57c");
