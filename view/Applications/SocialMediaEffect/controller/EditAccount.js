sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.SocialMediaEffect.controller.EditAccount", {
		club_dms_id: '',
		account_verficiation_proof_cmis_id: 'null',
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(),
				"pwc.portal.eval.ClubEvaluations.view.Applications.SocialMediaEffect.view.EditAccount", this);
			this._bInit = false;
		},
		...
		// 			"required": true
		// 		}, {
		// 			"id": "social_media_account_entity",
		// 			"type": "text",
		// 			"required": false
		// 		}, {
		...
		onpress_Editaccount: function (oEvent) {
			var oView = this.getView(),
				...
				status = true,
				requiredFieldInfo = [{
					"id": "newsocial_media_account_status",
					"type": "select",
					"required": true
				}, {
					"id": "newsocial_media_account_name",
					"type": "text",
					"required": true
				}, {
					"id": "newsocial_media_account_type",
					"type": "select",
					"required": true
				}];
			...
			oEntry["club_id"] = '7';
			oEntry["created_by"] = "P00005";
			var sModel = this._oControl.getModel("SocialMediaEff");
			var sBindingPath = "/SMACC";
			sModel.setProperty(sBindingPath + '/social_media_account_status', oView.byId("newsocial_media_account_status").getSelectedKey());
			console.log(sModel);
