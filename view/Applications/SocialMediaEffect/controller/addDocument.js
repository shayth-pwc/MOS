sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.SocialMediaEffect.controller.addDocument", {
		club_dms_id: '',
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(),
				"pwc.portal.eval.ClubEvaluations.view.Applications.SocialMediaEffect.view.addDocument", this);
			this._bInit = false;
		},
		...
		handleUploadPress: function (oEvent) {
			...
			var sPath = "document_type_cmis_id";
		...
		openlink: function (oEvent) {
			var sLink = '';
			var filename = this.getView().byId('myFileUploadprocedure').getBindingContext("SocialMediaEff").getProperty('document_type_cmis_id');
