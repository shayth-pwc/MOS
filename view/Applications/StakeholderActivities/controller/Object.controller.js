sap.ui.define([
	...
	"use strict";
	return BaseController.extend("pwc.portal.eval.ClubEvaluations.view.Applications.StakeholderActivities.controller.Object", {
		formatter: formatter,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		...
		/**
		 *@memberOf pwc.portal.eval.ClubEvaluations.view.Applications.StakeholderActivities.controller.Object
		 */
		addnewactivity: function (oEvent) {
			...
			var oContext = this.getView().getModel().createEntry("/ACTIVITIES", {
				properties: {
					id: '-1',
					club_id:Math.floor(Math.random() * 1000) + "" ,
				stakeholder_id:this.getView().byId("object").mProperties.number,
					// stakeholder_id:Math.floor(Math.random() * 1000) + "",
					activity_description: "",
					activity_name: "",
					communication_type: "",
					frequency_of_communication: "",
					future_developments: "",
					activity_start_date: this.getView().byId("activity_start_date").mProperties.value,
					activity_end_date: this.getView().byId("activity_end_date").mProperties.value,
		...
		editactivity: function (e) {
			...
			if (!i) {
				i = new StakeholderActivities(this.getView());
				this.mDialogs[t] = i;
