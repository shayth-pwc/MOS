sap.ui.define([
	...
	return ManagedObject.extend("pwc.portal.eval.ClubEvaluations.view.Applications.PlanCEO.controller.plansCEOreview", {
	club_dms_id:'',

		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "pwc.portal.eval.ClubEvaluations.view.Applications.PlanCEO.view.plansCEOreview", this);
			this._bInit = false;
		},
		renderPDF: function (oEvent) {
			//Generate the token
			var modeldata = this.getView().byId("plans").getParent().mObjectBindingInfos.plansCEO.path;

			var data = this.getOwnerComponent().getModel("plansCEO").getProperty(modeldata);
			console.log(data);
			// 			 var x = "saif";
			// conslog.log(`hello  ${x} `);
